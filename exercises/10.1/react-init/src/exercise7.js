...
function CardList() {
  return (
    <div className="row">
      ...
      <div className="col-sm-4">
        <Card
          featureImage="https://sebhastian.com/static/cta-react-distilled-d1a3dc470cbfafb1c7d56c72f262649e.jpg"
          title="Conrado lider mudial"
          description="Learn the paraquedist of learning React to luan santana"
          link="https://sebhastian.com/js-before-react"
        />
      </div>
      <div className="col-sm-4">
